@php/** @var string|null $logoBase64 */ /** @var string|null $sigBase64 */ /** @var string|null $sealBase64 */ /** @var string|null $globalLogoBase64 */ /** @var string|null $globalSigBase64 */ /** @var string|null $globalAffiliatedPartner */ /** @var string|null $globalRegNo */ /** @var string|null $globalName */ /** @var string|null $profilePhotoBase64 */ /** @var string|null $initials */ /** @var string|null $designation */ /** @var string|null $cardNumber */ /** @var string|null $dob */ /** @var string|null $joiningDate */ /** @var string|null $mobile */ /** @var string|null $address */ /** @var string|null $barcodeBase64 */ /** @var string|null $companyWebsite */ /** @var string|null $companyAffiliatedWith */ /** @var string|null $companyRegNo */ /** @var string|null $qrBase64 */ /** @var string|null $companyEmergency */ /** @var string|null $icardVerifiedBy */ /** @var string|null $companyAddress */ /** @var string|null $companyPhone */ /** @var string|null $companyEmail */@endphp<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><style>
    /* Absolute reset to prevent blank pages */
    html, body {
      margin: 0; padding: 0;
      width: 570pt; height: 490pt;
      overflow: hidden;
      background: #0d1b2a;
    ...
    .navy-header {
      position: absolute;
      top: 0; left: 0;
      width: 270pt; height: 165pt;
      background: #04111F;
    }
    .gold-line {
      position: absolute;
      top: 163pt; left: 0; width: 270pt; height: 2pt;
      background: #FF9500;
    }

    .curve-mask {
      position: absolute;
      top: 145pt; left: -15pt; width: 300pt; height: 40pt;
      background: #f5f3ee;
    ...
    .dot {
      position: absolute;
      top: 198pt; left: 133pt; width: 4pt; height: 4pt;
      background: #FF9500; border-radius: 2pt;
    }

    .info-table {
      position: absolute;
      top: 212pt; left: 15pt; width: 240pt;
      border-collapse: separate;
      border-spacing: 5pt;
    }
    .info-cell {
    ...
    /* Verification Row (Front) - Moved up slightly and refined */
    .sig-row-front {
      position: absolute;
      top: 330pt; left: 15pt; width: 240pt;
      z-index: 100;
    }
    .sig-box { width: 110pt; float: left; text-align: center; }
    .sig-img-wrap { height: 25pt; position: relative; margin-bottom: 2pt; }
    .sig-img { height: 18pt; vertical-align: middle; }
    ...
    .barcode-area {
      position: absolute;
      top: 388pt; left: 15pt; width: 240pt;
    }
    .barcode-img { height: 22pt; width: 140pt; }
    .barcode-val { float: right; color: #8a9bb0; font-size: 7pt; margin-top: 6pt; }
    ...
    .notice-box {
      position: absolute;
      top: 230pt; left: 20pt; width: 230pt;
      background: rgba(255,149,0,0.07);
      border: 0.5pt solid rgba(255,149,0,0.18);
      border-radius: 8pt; padding: 10pt;
      text-align: center;
    }
    .notice-box p { color: #c8d8e8; font-size: 7pt; line-height: 1.4; margin: 0; }
    .notice-box strong { color: #FFF; }

    .emergency-pill {
      position: absolute;
      top: 305pt; left: 55pt; width: 160pt;
    ...
    .sig-row-back {
      position: absolute;
      top: 345pt; left: 15pt; width: 240pt;
