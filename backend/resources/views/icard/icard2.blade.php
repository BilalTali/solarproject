...
<head>
    ...
    <style>
        ...
        body { margin: 0; padding: 0; background: #0d1b2a; font-family: Helvetica, Arial, sans-serif; }

        .main-table {
            width: 570pt;
            height: 500pt;
            border-collapse: separate;
            border-spacing: 15pt 30pt;
        }
        ...
        .navy-header { position: absolute; top: 0; left: 0; width: 100%; height: 160pt; background: #04111F; z-index: 1; }
        .gold-line { position: absolute; top: 158pt; left: 0; width: 100%; height: 2.5pt; background: #FF9500; z-index: 3; }
        .curve-overlay { position: absolute; top: 135pt; left: -20pt; width: 300pt; height: 45pt; background: #f5f3ee; border-radius: 100% 100% 0 0; z-index: 2; }
        
        .logo-area { position: absolute; top: 15pt; left: 15pt; z-index: 4; }
        .logo-box { width: 36pt; height: 36pt; background: #FF9500; border-radius: 8pt; text-align: center; }
        .company-header { position: absolute; top: 16pt; left: 60pt; width: 185pt; z-index: 4; }
        ...
        .name-text { position: absolute; top: 175pt; left: 0; width: 100%; text-align: center; font-size: 15pt; font-weight: bold; color: #04111F; text-transform: uppercase; z-index: 5; }
        .divider-container { position: absolute; top: 200pt; left: 0; width: 100%; text-align: center; z-index: 5; }
        .divider { display: inline-block; width: 220pt; height: 1pt; background: #FF9500; opacity: 0.4; position: relative; }
        .dot { position: absolute; top: -2pt; left: 108pt; width: 5pt; height: 5pt; background: #FF9500; border-radius: 2.5pt; }

        .info-grid { position: absolute; top: 215pt; left: 15pt; width: 230pt; z-index: 5; border-collapse: separate; border-spacing: 0 5pt; }
        .info-cell { width: 110pt; background: #FFF; border: 0.5pt solid #04111F; border-left: 2.5pt solid #FF9500; border-radius: 6pt; padding: 5pt 8pt; vertical-align: top; }
        .lbl { color: #8a9bb0; font-size: 6.5pt; font-weight: bold; text-transform: uppercase; margin-bottom: 2pt; }
        .val { color: #04111F; font-size: 8pt; font-weight: bold; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .val-gold { color: #FF9500; }

        .barcode-area { position: absolute; top: 355pt; left: 20pt; width: 220pt; z-index: 5; }
        ...
        .footer-line { position: absolute; top: 405pt; left: 15pt; width: 230pt; height: 0.5pt; background: #FF9500; opacity: 0.25; z-index: 5; }
        .footer-text { position: absolute; top: 415pt; left: 15pt; width: 230pt; font-size: 8pt; font-weight: bold; z-index: 5; }
        .f-left { float: left; color: #FF9500; text-transform: uppercase; }
        .f-right { float: right; color: #8a9bb0; font-weight: normal; }
        .v-dot { display: inline-block; width: 4pt; height: 4pt; border-radius: 2pt; background: #28a745; margin-right: 5pt; margin-bottom: 1pt; vertical-align: middle; }

        /* Back specific */
        .back-bg { background: #04111F; width: 100%; height: 100%; position: absolute; top: 0; left: 0; }
        .back-header { position: absolute; top: 20pt; left: 20pt; width: 220pt; padding-bottom: 8pt; border-bottom: 0.5pt solid #FF9500; }
        ...
        .notice-box { position: absolute; top: 215pt; left: 25pt; width: 210pt; background: #0a1f35; border: 0.5pt solid #FF9500; border-radius: 10pt; padding: 10pt; text-align: center; }
        ...
        .sig-container { position: absolute; top: 335pt; left: 15pt; width: 230pt; padding-top: 10pt; border-top: 0.5pt solid #FF9500; }
                    ...
                    <div class="front-bg">
                        ...
                        <table class="info-grid">
                            <tr>
                                ...
                                <td class="info-cell" style="padding-left: 5pt;">
