...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        if (isset($validated['aadhaar_number']) && empty($validated['aadhaar_number'])) unset($validated['aadhaar_number']);
        if (isset($validated['bank_account_number']) && empty($validated['bank_account_number'])) unset($validated['bank_account_number']);
