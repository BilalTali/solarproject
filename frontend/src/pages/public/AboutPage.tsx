        ...
        <div className="min-h-screen bg-neutral-50 flex flex-col">
            ...
            <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
                    <h1 className="text-4xl font-display font-bold text-dark mb-6 text-center">About {companyName}</h1>
                    ...
                    <div className="prose prose-blue max-w-none text-neutral-700">
                        <p>Welcome to {companyName}, your trusted partner in navigating the PM Surya Ghar Muft Bijli Yojana. We are a specialized platform dedicated to connecting homeowners with qualified solar agents and facilitators.</p>
