            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <a href="/#lead-form" className="btn-accent text-sm py-2 px-5">{settings?.nav_cta_electricity || 'Get Free Electricity'}</a>
                        <Link to="/login" className="btn-ghost text-sm py-2 px-5">{settings?.nav_portal_login || 'Portal Login'}</Link>
                    </div>
