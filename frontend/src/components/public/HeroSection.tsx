                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="animate-slide-up">
                        ...
                        <div className="flex flex-col sm:flex-row gap-5">
                            ...
                            <a href="/enumerator/register" className="glass-card px-8 py-3 flex items-center justify-center gap-3 text-white font-bold hover:bg-white/20 transition-all border-white/10">
